...
Template.flexTabBar.events({
	'click .tab-button'(e, instance) {//报销
		e.preventDefault();
		if (this.id == 'reimbursement') {
			FlowRouter.go('channel', {'name':'baoxiao'}, {});
		} else if (this.id == 'leavevocation') {
			FlowRouter.go('channel', {'name':'leave-vocation'}, {});
		} else {
